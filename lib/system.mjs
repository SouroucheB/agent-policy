...
export function initProject(root, { upgrade = false } = {}) {
  ...
  return copies.some(copy => copy.before !== null && copy.before !== copy.content) && upgrade === false
    ? 'Politique conservée ; utiliser init --upgrade pour actualiser le socle, le générateur et la commande brief.'
    : `Initialisé : ${PROJECT_FILES.policy}, socle, générateur et commande brief v${VERSION}.`;
}
